...
int main() {
	...
	while (true) {
		...
		while (true) {
			...
			double j1 = ((double)SDL_JoystickGetAxis(joy, 1)) / -32767.0;
			double j2 = ((double)SDL_JoystickGetAxis(joy, 2)) / -32767.0;
			double j3 = ((double)SDL_JoystickGetAxis(joy, 3)) / -32767.0;
			double j4 = ((double)SDL_JoystickGetAxis(joy, 4)) / -32767.0;
			double j5 = ((double)SDL_JoystickGetAxis(joy, 5)) / -32767.0;
			double j0 = ((double)SDL_JoystickGetAxis(joy, 0)) / -32767.0;
